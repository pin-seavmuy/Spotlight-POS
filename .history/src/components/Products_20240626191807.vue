  ...
  export default {
    ...
    data() {
      return {
        ...
        orders: [
          { id: 1, productID: 'C0001', image: 'people.png', product: 'Flower Dress',  category: "Dress", color: "N/A", color: "Gray" },
          { id: 2, productID: 'C0002',  image: 'people.png', product: 'Prada', category: "Hoodie",  color: "Gray"  },
