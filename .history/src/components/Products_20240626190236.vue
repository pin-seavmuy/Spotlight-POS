  ...
  export default {
    ...
    data() {
      return {
        ...
        orders: [
          { id: 1, image: 'path/to/image1.jpg', productID: 'C0001', category: "Dress" },
          { id: 2, image: 'path/to/image2.jpg', productID: 'C0002', category: "Hoodie" },
          { id: 3, image: 'path/to/image3.jpg', productID: 'C0003', category: "T-shirt" },
        ],
      };
    },
    // methods: {
