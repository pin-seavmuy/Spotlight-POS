  ...
  <script>
    ...
    data() {
      return {
        ...
        orders: [
          { id: 1, customer: 'John Doe',  product: 'Cigarella Skill Shirt', size: 'M', color: 'Black', qty: 2, price: '$50.00', status: 'Pending' },
          { id: 2, customer: 'Jane Smith',  product: 'Wool Tweed A-Line', size: 'M', color: 'N/A', qty: 1, price: '$15.00', status: 'Pending' },
          { id: 3, customer: 'Michael Brown',  product: 'Cheyenne Floral Dress', size: 'M', color: 'N/A', qty: 1, price: '$35.00', status: 'Shipped' },
