...
<script>
  ...
  import { faBell, faShoppingBasket, faThLarge, faDatabase, faListAlt, faCreditCard, faBoxOpen, faUsers, faSearch, faEdit, faTrash, fa } from '@fortawesome/free-solid-svg-icons';
  export default {
    name: "ProductPage",
    components: {
      FontAwesomeIcon,
