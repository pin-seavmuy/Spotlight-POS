    ...
    data() {
      return {
        ...
        orders: [
          ...
          { id: 2, customer: 'Jane Smith', productId: 'C0002', product: 'Wool Tweed A-Line', size: 'M', color: 'N/A', qty: 1, price: '$15.00', status: 'Processing' },
          { id: 3, customer: 'Michael Brown', productId: 'C0003', product: 'Cheyenne Floral Dress', size: 'M', color: 'N/A', qty: 1, price: '$50.00', status: 'Delivered' },
