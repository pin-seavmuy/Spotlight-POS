<template>
  ...
  <script>
    ...
    data() {
        ...
        orders: [
          { id: 1, productID: 'C0001', total: '$50.00', orderDate: '26/06/24' },
          { id: 2,  productID: 'C0002', total: '$15.00', orderDate: '26/06/24' },
          { id: 3, productID: 'C0003', total: '$35.00', orderDate: '26/06/24'},
        ],
        };
    },
    };
