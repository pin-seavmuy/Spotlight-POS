  ...
  <script>
    ...
    data() {
      return {
        ...
        orders: [
          { id: 1, customer: 'John Doe',  product: 'Cigarella Skill Shirt',  total: '$50.00', orderDate: '26/06/24',  status: 'Pending' },
          { id: 2, customer: 'Jane Smith',  product: 'Wool Tweed A-Line', total: '$15.00', orderDate: '26/06/24', status: 'Pending' },
          { id: 3, customer: 'Michael Brown',  product: 'Cheyenne Floral Dress', total: '$35.00', orderDate: '26/06/24', status: 'Shipped' },
