<template>
  ...
  <script>
    ...
    data() {
        ...
        orders: [
          { id: 1, product: 'Cigarella Skill Shirt', total: '$50.00', orderDate: '26/06/24' },
          { id: 2,  product: 'Wool Tweed A-Line', total: '$15.00', orderDate: '26/06/24' },
          { id: 3, product: 'Cheyenne Floral Dress', total: '$35.00', orderDate: '26/06/24'},
        ],
        };
    },
    };
